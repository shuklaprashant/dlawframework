...
<body>
	...
	<main>
		<div class="container-fluid">
			<div class="row">
				<div class="slide_title text-center">
					<div class="form-group">
						<h3 class="white_txt display-4">
								Legal
							</h3>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="about_us">
						...
						<h5>Research & Content Solutions</h5>
						<p class="lg_txt">
			...
			<div class="row">
				<div class="about_banner text-center white_txt">
					<div class="col-md-10">
						<div class="row">
							<div class="col-md-4">
								<p class="m-b-0">Total Search</p>
								<p class="display-4 m-b-0">
									4564
								</p>
							</div>
							<div class="col-md-4">
